...
@czujniki_bp_v1.route('/czujniki', methods=['GET'])
def get_czujniki():
    query = Czujnik.query
...
@czujniki_bp_v1.route('/czujniki/<int:czujnik_id>', methods=['GET'])
...
@czujniki_bp_v1.route('/czujniki/<int:czujnik_id>/aktualne', methods=['GET'])
...
@czujniki_bp_v1.route('/czujniki/<int:czujnik_id>/historyczne', methods=['GET'])
